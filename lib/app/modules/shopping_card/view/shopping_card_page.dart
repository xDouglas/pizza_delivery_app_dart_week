...
import 'package:pizza_delivery_app/app/modules/shopping_card/components/shopping_card_item.dart';
import 'package:pizza_delivery_app/app/modules/shopping_card/controller/shopping_card_controller.dart';
...
class _ShoppingCardPageState extends State<ShoppingCardPage> with LoaderMixin, MessagesMixin {
              ...
              : Column(
                  children: [
                    ...
                    ListTile(
                      ...
                      trailing: FlatButton(onPressed: () => changeAddress(), child: Text('alterar', style: TextStyle(color: Theme.of(context).primaryColor))),
                    ),
                    Divider(),
                    ListTile(
  ...
  Widget _buildShoppingCardItems(BuildContext context, ShoppingCardController controller) {
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [Text('Total'), Text(numberFormat.format(controller.totalPrice))],
          ),
        ),
        FlatButton(
  ...
  Widget _buildClearShoppingCard(BuildContext context) {
    return Center(
        child: Column(
      children: [Icon(AntDesign.shoppingcart, size: 200), Text('Seu carrinho está vazio')],
    ));
  }
    ...
    showDialog(
        ...
        builder: (_) {
          return AlertDialog(
            ...
            actions: [
              RaisedButton(onPressed: () => Navigator.pop(context), child: Text('Cancelar')),
              RaisedButton(
                  onPressed: () {
                    context.read<ShoppingCardController>().changeAddress(addressEditingController.text);
        ...
        builder: (_) {
          ...
          return AlertDialog(
            ...
            actions: [
              ...
              RaisedButton(
                  onPressed: () {
                    context.read<ShoppingCardController>().changePaymentType(paymentTypeSelected.value);
                    Navigator.pop(context);
                  },
                  child: Text('Alterar')),
            ],
