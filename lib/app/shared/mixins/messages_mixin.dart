...
abstract class MessagesMixin {
  ...
  }) => _showSnackBar(context: context, color: Colors.red, message: message, key: key);
    
  showSuccess({
    @required String message,
    BuildContext context,
    GlobalKey<ScaffoldState> key
  }) => _showSnackBar(context: context, color: Theme.of(context).primaryColor, message: message, key: key);
